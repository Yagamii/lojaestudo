<div class="content-border">
	<div class="content-user">
        ...
        <label>Sobrenome:</label><input type="text" name="sobrenome" value="<?php echo $_infos['sobrenome']; ?>" /><br/><br/>
        <label>Email:</label><input type="text" name="email" value="<?php echo $_infos['email']; ?>" /><br/><br/>
        <label>Usuário:</label><input type="text" name="usuario" value="<?php echo $_infos['usuario']; ?>" /><br/><br/>
        <label>Função:</label><select name="nivel">
        						<option></option>
